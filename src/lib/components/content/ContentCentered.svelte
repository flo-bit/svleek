<script>
	...
	import WarningAlert from '../Alerts/WarningAlert.svelte';
</script>

<!-- Don't use this, this is just for reference, use ContentCenteredMarkdown -->

<div class="px-6 py-32 lg:px-8">
	<div class="mx-auto max-w-3xl text-base leading-7 text-neutral-700 dark:text-neutral-300">
		<p class="text-base font-semibold leading-7 text-accent-600 dark:text-accent-500">
			Introducing
		</p>
		<h1
			class="mt-2 text-3xl font-bold tracking-tight text-neutral-900 dark:text-neutral-100 sm:text-4xl"
		>
		...
		<div class="mt-10 max-w-2xl">
			...
			<ul role="list" class="mt-8 max-w-xl space-y-8 text-neutral-600 dark:text-neutral-400">
				...
				<li class="flex gap-x-3">
					...
					<span
						><strong class="font-semibold text-neutral-900 dark:text-neutral-100">Loops.</strong> Anim
						aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo.</span
					>
				</li>
				<li class="flex gap-x-3">
					<svg
					...
					<span
						><strong class="font-semibold text-neutral-900 dark:text-neutral-100">Events.</strong> Ac
						tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</span
					>
				</li>
			</ul>
			<p class="mt-8">
			...
			<h2 class="mt-16 text-2xl font-bold tracking-tight text-neutral-900 dark:text-neutral-100">
			...
			<figure class="mt-10 border-l border-accent-600 dark:border-accent-500 pl-9">
				<blockquote class="font-semibold text-neutral-900 dark:text-neutral-100">
					<p>
				...
				<figcaption class="mt-6 flex gap-x-4">
					...
					<div class="text-sm leading-6">
						<strong class="font-semibold text-neutral-900 dark:text-neutral-100">Maria Hill</strong>
						- Marketing Manager
					</div>
				</figcaption>
			</figure>
		...
		<figure class="mt-16">
			<img
				class="aspect-video rounded-xl bg-neutral-50 object-cover"
				src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&auto=format&fit=facearea&w=1310&h=873&q=80&facepad=3"
				alt=""
			/>
			<figcaption class="mt-4 flex gap-x-2 text-sm leading-6 text-neutral-500">
				<svg
					class="mt-0.5 h-5 w-5 flex-none text-neutral-300"
					viewBox="0 0 20 20"
					fill="currentColor"
					aria-hidden="true"
				>
